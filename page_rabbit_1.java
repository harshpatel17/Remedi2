...
public class page_rabbit_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_rabbit_1);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(page_rabbit_1.this, pet_page_1.class);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(page_rabbit_1.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
        });
